...
pub const DATA_SOURCE_ARGENTINA_DATOS: &str = "ARGENTINA_DATOS";
pub const DATA_SOURCE_DOLAR_API: &str = "DOLAR_API";
pub const DATA_SOURCE_BALANZ_FCI: &str = "BALANZ_FCI";
pub const DATA_SOURCE_PPI: &str = "PPI";
pub const MARKET_DATA_PROVIDER_IDS: [&str; 13] = [
    DATA_SOURCE_YAHOO,
